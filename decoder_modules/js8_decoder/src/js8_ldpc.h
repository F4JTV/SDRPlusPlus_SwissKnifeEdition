// JS8 LDPC(174,87) parity matrices and core size constants.
// Tables are the PEG-generated LDPC code from WSJT-X / JS8Call
// (originally ldpc_174_87_params.f90), required verbatim for protocol
// interoperability. Ported from JS8Call's JS8.cpp.
#pragma once
#include <array>
#include <cstdint>
